/** Vocabulary topics for Marina. */
window.VOCABULARY_DATA = [
  {
    "id": "vocab-lesson-1-jobs-studies",
    "title": "Jobs and studies",
    "label": "Lesson 1A · 30 essential words and phrases",
    "icon": "💼",
    "type": "lesson",
    "linkedLessonId": "lesson-1",
    "page": "vocabulary.html?id=vocab-lesson-1-jobs-studies",
    "description": "30 наиболее полезных элементов из домашней работы: профессии, учебные статусы и ключевые выражения для заданий 1A–3D.",
    "words": [
      {
        "id": "l1-01",
        "uniqueKey": "basketball player",
      ...
      {
        "id": "l1-28",
        "uniqueKey": "work in the government",
        "en": "work in the government",
